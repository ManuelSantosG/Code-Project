...
for i=1:n
    monthly_generated(i,1)=nansum(gP(i,1:31));
    monthly_generated(i,2)=nansum(gP(i,32:59));
    monthly_generated(i,3)=nansum(gP(i,60:90));
    monthly_generated(i,4)=nansum(gP(i,91:120));
    monthly_generated(i,5)=nansum(gP(i,121:151));
    monthly_generated(i,6)=nansum(gP(i,152:181));
    monthly_generated(i,7)=nansum(gP(i,182:212));
    monthly_generated(i,8)=nansum(gP(i,213:243));
    monthly_generated(i,9)=nansum(gP(i,244:273));
    monthly_generated(i,10)=nansum(gP(i,274:304));
    monthly_generated(i,11)=nansum(gP(i,305:334));
    monthly_generated(i,12)=nansum(gP(i,335:365));
end
